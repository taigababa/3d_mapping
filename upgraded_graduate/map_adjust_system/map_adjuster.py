...
cv2.createTrackbar("front_dist","image",145,300,nothing)
...
cv2.createTrackbar("side_dist","image",125,300,nothing)
...
while(1):
    ...
    #mapフィルターがけ
    map_true_filtered = FILTER.Gaussian_blur_3D(map_true,3,0.2)
