...
Show_COLOR.show_3D_color_nonum(map_true_filtered,'black',1)
map_demo = Hi_PROJECTION.make_3D_array(z_range,x_range,y_range)
map_demo = map_true_filtered
map_demo = map_demo.transpose(2,1,0)
Show_COLOR.show_3D_color(map_demo,'black',1)
...
Show_COLOR.show_3D_color_nolabel(map_front_side,'black',1)
...
#2
x=30
slice_img_viewer(x,map_with_ground,"slice2_ground_front_side")

#3
x = 60
slice_img_viewer(x,map_with_ground,"slice3_ground_front_side")


#1
x = 20
slice_img_viewer(x,map_with_ground,"slice1_ground_front_side")
#4
x = 90
slice_img_viewer(x,map_with_ground,"slice4_ground_front_side")
